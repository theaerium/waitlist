          ...
          <div className="block md:hidden space-y-8">
            ...
            <div className="text-left">
              <p className="text-sm mb-2">
                Available daily, 8am to 10:00 PM ET
              </p>
            ...
            <div className="text-left text-sm">
              <p>
                *Aerium is a financial services product, not a bank. Prepaid
                debit cards are issued by People&apos;s Trust via Reloadly
              </p>
            </div>
          </div>
